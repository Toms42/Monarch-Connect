...
void
NodePainter::paint(QPainter* painter, NodeGraphicsObject const& graphicsObject)
{
...
void
NodePainter::drawNodeRect(QPainter* painter,
...
void
NodePainter::drawConnectionPoints(QPainter* painter,
                                  NodeGraphicsObject const& graphicsObject)
{
...
void
NodePainter::drawModelName(QPainter* painter,
                           NodeGraphicsObject const& graphicsObject)
{
  FlowSceneModel const& model = *graphicsObject.index().model();
  NodeStyle const& nodeStyle = model.nodeStyle(graphicsObject.index());
...
void
NodePainter::drawEntryLabels(QPainter* painter,
                             NodeGraphicsObject const& graphicsObject)
{
  NodeState const& state = graphicsObject.nodeState();
  NodeGeometry const& geom = graphicsObject.geometry();
...
void
NodePainter::drawValidationRect(QPainter* painter,
                                NodeGraphicsObject const& graphicsObject)
{
  FlowSceneModel const& model = *graphicsObject.index().model();
  NodeGeometry const& geom = graphicsObject.geometry();
