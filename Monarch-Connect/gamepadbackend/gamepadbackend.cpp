...
bool QGamepadBackend::configureButton(int /*deviceId*/, GamepadButton /*button*/)
{
    return false;
}

bool QGamepadBackend::configureAxis(int /*deviceId*/, GamepadAxis /*axis*/)
{
    return false;
}

bool QGamepadBackend::setCancelConfigureButton(int /*deviceId*/, GamepadButton /*button*/)
{
    return false;
}
