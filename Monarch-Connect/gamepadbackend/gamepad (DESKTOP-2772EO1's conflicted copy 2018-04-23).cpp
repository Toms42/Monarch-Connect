    ...
    //: QObject(*new QGamepadPrivate(deviceId), parent)
{
    ...
    connect(gamepadManager, SIGNAL(gamepadConnected(int)), this, SLOT(_q_handleGamepadConnected(int)));
    connect(gamepadManager, SIGNAL(gamepadNameChanged(int, QString)), this, SLOT(_q_handleGamepadNameChanged(int, QString)));
    connect(gamepadManager, SIGNAL(gamepadDisconnected(int)), this, SLOT(_q_handleGamepadDisconnected(int)));
    connect(gamepadManager, SIGNAL(gamepadAxisEvent(int,QGamepadBackend::GamepadAxis,double)), this, SLOT(_q_handleGamepadAxisEvent(int,QGamepadBackend::GamepadAxis,double)));
    connect(gamepadManager, SIGNAL(gamepadButtonPressEvent(int,QGamepadBackend::GamepadButton,double)), this, SLOT(_q_handleGamepadButtonPressEvent(int,QGamepadBackend::GamepadButton,double)));
    connect(gamepadManager, SIGNAL(gamepadButtonReleaseEvent(int,QGamepadBackend::GamepadButton)), this, SLOT(_q_handleGamepadButtonReleaseEvent(int,QGamepadBackend::GamepadButton)));

    setConnected(gamepadManager->isGamepadConnected(deviceId));
    setName(gamepadManager->gamepadName(deviceId));
}
